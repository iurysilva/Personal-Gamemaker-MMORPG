...
if (_player){
	...
	if (mouse_check_button_pressed(mb_right) and _player.stamina >= 10){
		_player.stamina -= 10
		alarm[1] = 180
		alarm[0] = 8
	...
	if (alarm[1] <= 0 and _player.stamina < _player.max_stamina) _player.stamina += 1

	if (_player.state == scr_player_dashing){
